...
<div class='col-md-4'>
      ...
      <div class='panel-heading' style='font-weight: bold; '>$pro_title</div>
      <img src='product_images/$pro_image' alt='Avatar'  style='width:160px; height:250px; '/>
      </div>
		
		<div style='border-bottom: 0.5px solid gray;' class='panel-heading'>$.$pro_price.00
		 <br>
		  <a href='#' class='btn btn-info btn-lg' style='height: 22px; width: 60px; font-size: 14px; padding: 2px;'>
          <span class='glyphicon glyphicon-thumbs-up'></span> Like
          </a>
          <a href='#' class='btn btn-info btn-lg' style='height: 22px; width: 70px; font-size: 14px; padding: 2px;'>
          <span class='glyphicon glyphicon-thumbs-down'></span> DisLike
          </a>
		  <button pid='$pro_id' style='item-align: center; height: 30px; width: 100px; font-size: 14px; padding: 2px; text-align: center;' id='product' class='btn btn-danger 
			btn-xs'>AddToCart</button>
		</div>
